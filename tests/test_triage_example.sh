...
echo ""
echo " Next Steps:"
echo "1. Check the incident via API: GET /api/v1/incidents/{incident_id}"
echo "2. For Example 2, you should see a pending action requiring human review"
echo "3. Use the WebSocket connection to see real-time state updates: ws://localhost:8001/api/v1/agents/{incident_id}/state"
echo "4. Review and approve/reject the triage output via API: PUT /api/v1/incidents/{incident_id}/feedback"
