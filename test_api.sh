...
echo "3️⃣  Ingesting Sample Runbook..."
...
echo "4️⃣  Testing Triage (Synchronous)..."
...
if [ -z "$INCIDENT_ID" ]; then
    echo "   ⚠️  No incident_id returned. Check logs."
    exit 1
fi
...
# Test 5: Get Incident
echo "5️⃣  Fetching Incident Details..."
...
echo "7️⃣  Testing Triage (State-Based HITL)..."
...
# Test 8: Metrics
echo "8️⃣  Checking Metrics Endpoint..."
