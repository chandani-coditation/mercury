...
const makeInitialAlert = () => {
  // Sample database alert from test_incidents.csv (INC6039763)
  // This is a real SQL Server Agent Job failure database incident - exact data from CSV
  return {
    alert_id: "INC6039763",
    title: "SentryOne Monitoring/Alert",
    description: `10/29/2025 7:00:00 PM -> :

  The job failed. Unable to determine if the owner (INT\\Ssubramanian) of job BACKUP_Native_SYS_DB_Full has server access (reason: Could not obtain information about Windows NT group/user 'INT\\Ssubramanian', error code 0x5. [SQLSTATE 42000] (Error 15404)).
 ...
 [Connection]: BRPRWSQL506.INT.MGC.COM

 [Object Name]: BACKUP_Native_SYS_DB_Full

 [Message]: Job 'BACKUP_Native_SYS_DB_Full' Failed

 [Start Time]: 10/29/2025 7:00:00 PM
 ...
 url:sqlsentry:brprwscv598a/Sentryone/em/eventview/?c=354&id=552179336

 ----------------------------------------------------------------------

 [Description]: Source: https://ola.hallengren.com

 [Owner]: INT\\Ssubramanian

 [Category]: Database Maintenance

 [Timestamp (Local)]: 10/29/2025 7:00:09 PM

 [Timestamp (UTC)]: 10/30/2025 2:00:09 AM

 [Generated By]: SolarWinds SQL Sentry 2025.1 Server [BRPRWMGT015]

 [Version]: 2025.1.1.47822

 [Monitor Type]: EventHistoryMonitor

 [Condition]: SQL Server Agent Job: Failure

 [Filter String]: Not Contains([Object Name], 'collection')
 ...
 [Configured Object Type]: Global`,
    source: "servicenow",
    category: "database", // Database alerts category
    labels: {
      service: "Database-SQL", // CSV shows affected_services: ['Database-SQL']
      component: "SQL Server Agent",
      cmdb_ci: "Database-SQL",
      environment: "production",
      severity: "high", // CSV shows severity: 'high'
      alertname: "SQL Server Agent Job Failure",
    },
    affected_services: ["Database-SQL"], // CSV shows affected_services: ['Database-SQL']
    ts: "2025-10-29T19:01:00", // CSV timestamp: 2025-10-29T19:01:00
  };
};
